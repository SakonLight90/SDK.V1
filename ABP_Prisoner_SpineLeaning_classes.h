...
struct UABP_Prisoner_SpineLeaning_C : UAnimInstance {
	...
	void AnimGraph(struct FPoseLink InPose, struct FPoseLink AnimGraph); // Function ABP_Prisoner_SpineLeaning.ABP_Prisoner_SpineLeaning_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1caed80
	...
	void ExecuteUbergraph_ABP_Prisoner_SpineLeaning(int32_t EntryPoint); // Function ABP_Prisoner_SpineLeaning.ABP_Prisoner_SpineLeaning_C.ExecuteUbergraph_ABP_Prisoner_SpineLeaning // (Final|UbergraphFunction) // @ game+0x1caed80
};
