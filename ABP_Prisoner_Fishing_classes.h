...
struct UABP_Prisoner_Fishing_C : UPrisonerAnimInstance_Fishing {
	...
	void AnimGraph(struct FPoseLink InPose, struct FPoseLink AnimGraph); // Function ABP_Prisoner_Fishing.ABP_Prisoner_Fishing_C.AnimGraph // (HasOutParms|BlueprintCallable|BlueprintEvent) // @ game+0x1caed80
	void ExecuteUbergraph_ABP_Prisoner_Fishing(int32_t EntryPoint); // Function ABP_Prisoner_Fishing.ABP_Prisoner_Fishing_C.ExecuteUbergraph_ABP_Prisoner_Fishing // (Final|UbergraphFunction) // @ game+0x1caed80
};
